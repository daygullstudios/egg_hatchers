/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 64fc63a82c663aa2cbfade9ab8381278)
// Runtime types generated with workerd@1.20260903.1 2026-09-07 
interface __BaseEnv_Env {
	SAFETY_AUTHORITY: D1Database;
	FIREBASE_PROJECT_ID: "egg-hatchers-dev";
	CAPABILITY_MODE: "protected_playtest";
	MATCHMAKING_POOL: "protected-v1";
	MATCHMAKING_SHARD_COUNT: "1";
	MATCHMAKING_ROUTING_MODE: "single_compatibility";
	MATCHMAKING: DurableObjectNamespace<import("./src/index").MatchmakingPool>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/index");
		durableNamespaces: "MatchmakingPool";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "FIREBASE_PROJECT_ID" | "CAPABILITY_MODE" | "MATCHMAKING_POOL" | "MATCHMAKING_SHARD_COUNT" | "MATCHMAKING_ROUTING_MODE">> {}
}
